...
| `villager_customers.mixin` | root | VillagerBrainMixin, VillagerRewardTradeXpMixin |  |
...
| `villager_customers.gametest` | root (gametest) | ComponentPredicateGameTest, DebugCommandGameTest, KeeperSeekGameTest, RefusalGameTest, ShopPoiGameTest, ShopSearchGameTest, ShopViewGameTest, ShoppingTripGameTest, SmokeGameTest, TestShop, TestShopNetwork, TransactionGameTest, VillageWideShopSearchGameTest |  |
