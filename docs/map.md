...
| `villager_customers.gametest` | root (gametest) | ComponentPredicateGameTest, DebugCommandGameTest, RefusalGameTest, ShopPoiGameTest, ShopSearchGameTest, ShopViewGameTest, ShoppingTripGameTest, SmokeGameTest, TestShop, TestShopNetwork, TransactionGameTest, VillageWideShopSearchGameTest |  |
